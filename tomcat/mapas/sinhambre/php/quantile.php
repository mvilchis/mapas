...
$conn = pg_connect('host='.getenv('POSTGRES_PORT_5432_TCP_ADDR').' dbname=sinhambreclone user=postgres password=posgres') or die(form_set_error('db', t('La base de datos no pudo ser contactado.')));
