...
.unidad {
	...
	<body>
		...
		<div id="agency-select-wrapper">
				...
				<div onmousedown='change_category("alimentacion");' id="alimentacion" class="varname agency nombre-agency-selected">Atención alimentaria</div>
<div onmousedown='change_category("serviv");' id="serviv" class="varname agency nombre-agency-selected">Servicios básicos y calidad en espacios de vivienda</div>
<div onmousedown='change_category("segsoc");' id="segsoc" class="varname agency nombre-agency-selected">Seguridad social y servicios de salud</div>
<div onmousedown='change_category("rezagoed");' id="rezagoed" class="varname agency nombre-agency-selected">Rezago educativo</div>
<div onmousedown='change_category("geningre");' id="geningre" class="varname agency nombre-agency-selected">Generación de ingresos empleo y opciones productivas</div>
<div onmousedown='change_category("partsoc");' id="partsoc" class="varname agency nombre-agency-selected">Participación social</div> 		
		...
		<div id="datos_mun">
			...
			<div class="mundata-box beneficiarios_box">
				<div class="box-title">Certificados</div>
				<div class="beneficiarios">--</div>
			</div>
			<div style="padding:5px;">Datos actualizados al 5 de enero de 2015</div>
		</div>
		...
		<script type="text/javascript" charset="utf-8">
			...
			function add_municipios_layer(v1) {
				...
				municipios = new L.TileLayer.WMS("/geoserver/sinhambre/wms", {
					...
					transparent: 'true',
					sld: 'http://104.236.179.77/sinhambre/php/quantile2.php?var='+c_var,
					format: 'image/png',
					opacity: '.8',
					tiled: 'true',
					detectRetina: 'true'
		    ...
		    function change_category(cat_name) {
				...
				$("#datos").empty();
				$("#datos").append('<div class="datos-title varlist-title">Certificación</div>');
		    ...
		    function searchMunicipio() {
			    (function ($) {
			    	$.getJSON( "/sinhambre/php/munsearch2.php", { s: $("#searchbox").val() } )
					.done(function( data ) {
						c_data = data;
		    ...
		    map.on('click', function(e) {
			    (function ($) {
			    	$.getJSON( "/sinhambre/php/attributes2.php", { lat: parseFloat(e.latlng.lat), lon: parseFloat(e.latlng.lng) } )
					.done(function( data ) {
						if (data != null) {
							c_data = data;
							if (highlight != null) map.removeLayer(highlight);
