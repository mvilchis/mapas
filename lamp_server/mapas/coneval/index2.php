...
.cat-desc {
	...
	<body>
		...
		<script type="text/javascript">
			...
			var pobreza_vars = {
				...
				"plb": {
					...
					"desc": "Ingreso inferior a la línea de bienestar media",
					"nom_por": "plb",
					"nom_per": "n_plb",
					"nom_cp": "cpplb"
				},
		...
		<div id="landing">
			<div id="landing-header">Ver mapas de ...</div>
			<div class="category">
				<div onmousedown="$('#landing').fadeOut();change_mode('pobreza');" class="cat-button blue-dark">Pobreza</div>
				<div class="cat-desc">Una persona se encuentra en situación de pobreza cuando tiene al menos una carencia social (en los seis indicadores de rezago educativo, acceso a servicios de salud, acceso a la seguridad social, calidad y espacios de la vivienda, servicios básicos en la vivienda y acceso a la alimentación) y su ingreso es insuficiente para adquirir los bienes y servicios que requiere para satisfacer sus necesidades alimentarias y no alimentarias.</div>
			</div>
			<div class="category">
				<div onmousedown="$('#landing').fadeOut();change_mode('rezago000510');" class="cat-button green-dark">Rezago Social</div>
				<div class="cat-desc">Rezago social es una medida en la que un solo índice agrega variables de educación, de acceso a servicios de salud, de servicios básicos en la vivienda, de calidad y espacios en la misma, y de activos en el hogar. No se trata de un medición de pobreza porque no incorpora los indicadores de ingreso, seguridad social y alimentación.</div>
			</div>
		</div>
		...
		<div class="varlist" id="varlist_pobreza"></div>
		
		<div class="varlist" id="varlist_rezago_social" style="display: none;"></div>
